import SourceTransposer from '../../lib/transposer/source_transposer.js';

describe('SourceTransposer', () => {
  const example = `{tone: A}
  ...
  it('transposes the source-code to C without formatting it', () => {
    const transposed = new SourceTransposer(example, 'C').transposedSource();
  ...
  it('transposes the source-code to Bb without formatting it', () => {
    const transposed = new SourceTransposer(example, 'Bb').transposedSource();
